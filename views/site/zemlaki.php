...
<div class="zemlakiPage">
	<!--<img style="width: 100%" src="/images/top/top2.jpg" alt="" />-->
	<div class="zemlakiBanner">
		<h1>Земляки</h1>
	</div>
	<div class="zemlakiContent">
		...
		<div class="zemlakiContentTable">	
			...
			<div class="zemlakiContentDate">
				<a href="<?php echo Url::to(['site/item-actions', 'id' =>$item['id']]); ?>">
					<h2><?php echo $date_words;?></h2>
				</a>
			</div>
			<div class="zemlakiContentTableText">
