...
<div class="landmarksPage">
	...
	<div class="landmarksContent">
		...
		<div class="landmarksContentTable">	
			<?php
			$monthes=[
			...
			<div class="landmarksContentDate">
				<a href="<?php echo Url::to(['site/item-actions', 'id' =>$item['id']]); ?>">
					<h2><?php echo $date_words;?></h2>
				</a>
			</div>
			<div class="landmarksContentTableText">
				<a href="<?php echo Url::to(['site/item-actions', 'id' =>$item['id']]); ?>">
					<?php 
