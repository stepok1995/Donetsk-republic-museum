...
<div class="ourhistoryPage">
	<!--<img style="width: 100%" src="/images/top/top2.jpg" alt="" />-->
	<div class="ourhistoryBanner">
		<h1>Страницы нашей истории</h1>
	</div>
	<div class="ourhistoryContent">
		...
		<div class="ourhistoryContentTable">	
			<?php
			$monthes=[
			...
			<div class="ourhistoryContentDate">
				<a href="<?php echo Url::to(['site/item-actions', 'id' =>$item['id']]); ?>">
					<h2><?php echo $date_words;?></h2>
				</a>
			</div>
			<div class="ourhistoryContentTableText">
				<a href="<?php echo Url::to(['site/item-actions', 'id' =>$item['id']]); ?>">
					<?php 
