...
<?php $this->beginBody() ?>
	...
	<ul class="sc_menu-body">
		...
		<li><a href="<?=Yii::$app->urlManager->createUrl(['admin/tpreiskurant'])?>"><span>Посетителю</span></a>
			<ul>
			<li><a href="<?=Yii::$app->urlManager->createUrl(['admin/tfeedback'])?>"><span>Книга отзывов</span></a></li>
...
<div>© www.drkm |
<span>Разработано отделом компьютерных технологий и дизайна Донецкого Республиканского Краеведческого Музея | 2020</span>
</div>
</div>
</div>
</footer>
